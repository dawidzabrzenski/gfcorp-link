        ...
        <div className="mt-4 flex flex-col gap-8 rounded-lg border border-gray-200 bg-white px-12 py-8 shadow-md">
          <div>
            ...
            <p className="text-gray-500">
              Streamline support, simplify success!
            </p>
          </div>
          <SignupForm />
          <p className="text-center text-sm text-gray-700">
            ...
            <span
              className="cursor-pointer text-maincolorlighter transition-colors duration-300 hover:text-maincolorlightest hover:underline"
